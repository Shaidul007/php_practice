    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="mt-5 bg-light-subtle border rounded-3 p-4">
            ...
            <h1 class="text-center text-success">SIGN UP</h1>
              ...
              <div class="form-group mt-3">
                <button name="registration" type="submit" class="btn btn-success me-2">Register</button>
                <a href="SignIn.php" class="btn btn-link">Already Register</a>
              </div>
          </form>
        </div>
      </div>
